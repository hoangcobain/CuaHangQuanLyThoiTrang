...
//	protected JTextField cmbTenNCC;
	...
	public SanPhamUI() {
		...
		btnLHD = new JButton("Thêm vào hóa đơn");
				...
				.addGroup(gl_pnlSanPham.createSequentialGroup()
					.addGroup(gl_pnlSanPham.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnlSanPham.createSequentialGroup()
							.addContainerGap()
							.addGroup(gl_pnlSanPham.createParallelGroup(Alignment.LEADING)
								.addComponent(scrSanPham, GroupLayout.DEFAULT_SIZE, 1087, Short.MAX_VALUE)
								.addComponent(pnlLeftSanPham, GroupLayout.PREFERRED_SIZE, 1087, Short.MAX_VALUE)
								.addGroup(gl_pnlSanPham.createSequentialGroup()
									.addComponent(btnThemSanPham, GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnCapNhatSanPham, GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnXoaSanPham, GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(btnXoaTrangSanPham, GroupLayout.DEFAULT_SIZE, 267, Short.MAX_VALUE))))
						.addGroup(gl_pnlSanPham.createSequentialGroup()
							.addGap(23)
							...
							.addGap(18)
							.addComponent(cmbTimTheoTen, 0, 199, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnTim, GroupLayout.PREFERRED_SIZE, 87, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(btnLHD, GroupLayout.PREFERRED_SIZE, 149, GroupLayout.PREFERRED_SIZE)
							.addGap(10)))
					.addGap(0)
		...
		gl_pnlSanPham.setVerticalGroup(
			gl_pnlSanPham.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_pnlSanPham.createSequentialGroup()
					.addGroup(gl_pnlSanPham.createParallelGroup(Alignment.LEADING)
						.addComponent(pnlRightSanPham, GroupLayout.DEFAULT_SIZE, 869, Short.MAX_VALUE)
						.addGroup(gl_pnlSanPham.createSequentialGroup()
							...
							.addGap(23)
							.addComponent(scrSanPham, GroupLayout.DEFAULT_SIZE, 547, Short.MAX_VALUE)))
					.addGap(0))
		);
