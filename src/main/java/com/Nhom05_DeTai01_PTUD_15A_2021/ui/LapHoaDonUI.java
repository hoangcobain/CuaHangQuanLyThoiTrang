...
public class LapHoaDonUI extends JPanel {
	...
	public LapHoaDonUI() {
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addComponent(pnlCenTer, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 1406, Short.MAX_VALUE)
						.addComponent(scrSanPham, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 1406, Short.MAX_VALUE)
						.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
							...
							.addComponent(txtTenKhachHang, GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
							...
							.addGap(18)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(cmbKhuyenMai, 0, 608, Short.MAX_VALUE)
								.addComponent(txtChietKhau, GroupLayout.DEFAULT_SIZE, 608, Short.MAX_VALUE))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnTim)
						.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
							.addComponent(txtTenKhachHang, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							.addComponent(lblTenKhachHang, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
					.addGap(18)
					.addComponent(pnlCenTer, GroupLayout.PREFERRED_SIZE, 420, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(scrSanPham, GroupLayout.DEFAULT_SIZE, 96, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_pnlCenTer.createSequentialGroup()
							.addGroup(gl_pnlCenTer.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_pnlCenTer.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(txtDonGia, GroupLayout.PREFERRED_SIZE, 397, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_pnlCenTer.createSequentialGroup()
									.addPreferredGap(ComponentPlacement.RELATED)
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(scrCTHD, GroupLayout.DEFAULT_SIZE, 849, Short.MAX_VALUE))
		...
		gl_pnlCenTer.setVerticalGroup(
			gl_pnlCenTer.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_pnlCenTer.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_pnlCenTer.createParallelGroup(Alignment.LEADING)
						.addComponent(scrCTHD, GroupLayout.DEFAULT_SIZE, 398, Short.MAX_VALUE)
						.addGroup(gl_pnlCenTer.createSequentialGroup()
							.addGroup(gl_pnlCenTer.createParallelGroup(Alignment.LEADING)
		...
		gl_pnlCenTer.linkSize(SwingConstants.HORIZONTAL, new Component[] {btnXoa, btnXoaTrang});
		gl_pnlCenTer.linkSize(SwingConstants.HORIZONTAL, new Component[] {btnThem, btnTimSP});
		...
		gl_pnlCenTer.linkSize(SwingConstants.HORIZONTAL, new Component[] {txtTenSanPham, txtTenNCC, txtMaSanPham, txtSoLuong, txtSize, txtGiaThanh, txtMauSac, txtDonGia});
